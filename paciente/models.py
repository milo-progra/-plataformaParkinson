...
class Familiar(models.Model):
    ...
    username_familiar   = models.OneToOneField(Usuario,on_delete=models.CASCADE, null=False, blank=False, primary_key=True, limit_choices_to={'tipo_usuario':3})
    rut_familiar        = models.CharField('Rut Familiar', max_length=10, unique=True)
    ...
    email_familiar      = models.CharField('Email Familiar', max_length=100, unique=True)
    ...
    telegram_familiar   = models.CharField('Telegram Familiar', max_length=100, null=True, blank=True, unique=True)
    
    
    def __str__(self):
        return str(self.username_familiar) + ' ' + str(self.apellido_familiar) 
...
class Paciente(models.Model):
    ...
    username_paciente    = models.OneToOneField(Usuario,on_delete=models.CASCADE, null=False, blank=False, primary_key=True, limit_choices_to={'tipo_usuario':1})
    rut_paciente         = models.CharField('Rut Paciente', max_length=10, unique=True)
    ...
    telegram_paciente    = models.CharField('Telegram Paciente', max_length=100, null=True, blank=True, unique=True)
    
    

    def __str__(self):
        return str(self.username_paciente) + ', rut: ' + self.rut_paciente
