...
urlpatterns = [
    ...
    path('neurologo/', login_required(neurologo), name="neurologo"),
    path('neurologo_paciente/', login_required(neurologo_paciente), name="neurologo_paciente"),
    path('neurologo_info_paciente/<username_paciente_id>' , login_required(neurologo_info_paciente), name="neurologo_info_paciente"),
    path('neurologo_info_paciente_vista/<username_paciente_id>' ,login_required(neurologo_info_paciente_vista), name="neurologo_info_paciente_vista"),
    path('receta/', login_required(receta), name="receta"),
    path('documento_admin/', login_required(documento_admin), name="documento_admin"),
    path('formularioemocion/', login_required(estado_animo_form), name="estado_animo_form"),
    path('automonitoreo_form/', login_required(automonitoreo_form), name="automonitoreo_form"),
    path('agregar_bitacora/<username_paciente_id>',login_required(agregar_bitacora), name="agregar_bitacora"),
    path('editar_comentario_bitacora/<id>', login_required(editar_comentario_bitacora), name="editar_comentario_bitacora"),
    path('editar_receta/<id_receta>', login_required(editar_receta), name="editar_receta"),
    path('eliminar_receta/<id_receta>', login_required(eliminar_receta), name="eliminar_receta"),
    path('agregar_receta/<username_paciente_id>', login_required(agregar_receta), name="agregar_receta"),
    path('chart_vista_animo/<username_paciente_id>', login_required(chart_vista_animo), name="chart_vista_animo"),
    path('chart_vista_automonitoreo/<username_paciente_id>', login_required(chart_vista_automonitoreo), name="chart_vista_automonitoreo"),
    ...
    path('enfermera_info_paciente/<username_paciente_id>' , login_required(enfermera_info_paciente), name="enfermera_info_paciente"),
    path('enfermera_vista_info_paciente/<username_paciente_id>' , login_required(enfermera_vista_info_paciente), name="enfermera_vista_info_paciente"),
    path('familiar_info_paciente/<username_paciente_id>' , login_required(familiar_info_paciente), name="familiar_info_paciente"),
    path('audio/<username_paciente_id>', audio, name="audio"),

    path('vocalizacion_paciente/<username_paciente_id>', login_required(vocalizacion_paciente), name="vocalizacion_paciente"),
    path('intensidad_paciente/<username_paciente_id>', login_required(intensidad_paciente), name="intensidad_paciente"),
    path('vista_audio_paciente/<username_paciente_id>', login_required(vista_audio_paciente), name="vista_audio_paciente"),
    path('vista_vocalizacion/<username_paciente_id>',login_required(vista_vocalizacion), name="vista_vocalizacion"),
    path('vista_intensidad/<username_paciente_id>', login_required(vista_intensidad), name="vista_intensidad"),
    path('fonoaudiologo/', fonoaudiologo, name="fonoaudiologo"),
    path('terapias_fono/', terapias_fono, name="terapias_fono"),

    
    path('fonoaudiologo_vista_info_paciente/<username_paciente_id>' , login_required(fonoaudiologo_vista_info_paciente), name="fonoaudiologo_vista_info_paciente"),
    ...
    path('admin_paciente/', login_required(admin_paciente), name="admin_paciente"),
    path('admin_receta_paciente/<username_paciente_id>',login_required(admin_receta_paciente), name="admin_receta_paciente"),
    path('admin_familiar/', login_required(admin_familiar), name="admin_familiar"),
    path('admin_info_familiar/<username_familiar_id>', login_required(admin_info_familiar), name="admin_info_familiar"),
    path('admin_neurologo/', login_required(admin_neurologo), name="admin_neurologo"),
    path('admin_info_neurologo/<username_neurologo_id>', login_required(admin_info_neurologo), name="admin_info_neurologo"),
    path('admin_fonoaudiologo/', login_required(admin_fonoaudiologo), name="admin_fonoaudiologo"),
    ...
    path('grafico_cantidad_usuarios/', login_required(grafico_cantidad_usuarios), name="grafico_cantidad_usuarios"),
    path('grafico_pacientes_comuna/', login_required(grafico_pacientes_comuna), name="grafico_pacientes_comuna"),
    path('grafico_neurologo_comuna/', login_required(grafico_neurologo_comuna), name="grafico_neurologo_comuna"),
    path('grafico_fonoaudiologo_comuna/', login_required(grafico_fonoaudiologo_comuna), name="grafico_fonoaudiologo_comuna"),
    path('grafico_enfermeras_comuna/',login_required(grafico_enfermeras_comuna), name="grafico_enfermeras_comuna"),

    path('admin_enfermera/', login_required(admin_enfermera), name="admin_enfermera"),
    path('admin_info_enfermera/<username_enfermera_id>', login_required(admin_info_enfermera), name="admin_info_enfermera"),
    path('documento/<username_paciente_id>', login_required(documento), name="documento"),
    path('telegram/<id>', login_required(telegram), name="telegram"),
    path('editar_comentario/<id>', login_required(editar_comentario), name="editar_comentario"),
    path('editar_comentario_intensidad/<id>', login_required(editar_comentario_intensidad), name="editar_comentario_intensidad"),
    path('editar_audio/<id_audio>/', login_required(modificar_audio), name='modificar_audio'),
    path('modificar_audio_fonoaudiologo/<id_audio>/', login_required(modificar_audio_fonoaudiologo), name='modificar_audio_fonoaudiologo'),
